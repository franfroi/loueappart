...
<div class="form-style">
    ...
    <p> <a href="#">*<span>Format Tel<br />0606060606</span> </a> </p>
    <input type="text" name="tel" id="tel" placeholder="Votre Numero de télephone *" tabindex="6">
    <div id="errortel" class="errors"></div>
...
<script src="js/scriptValidateFocusForm.js"></script>
</body>
</html>